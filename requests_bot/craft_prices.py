...
RECIPE_BOT_CAP = {
    "iron": 6,        # топ-earner, спрос 78% тянет 6-й слот
    "rawOre": 7,      # лучший спрос 84%, дёшево/быстро — держит рост
    "copper": 1,      # реал з/час 0.01 — мёртвый груз, режем
    "copperBar": 1,   # проба провалилась на 2, оставляем 1
    "bronze": 1,      # PROBE: теория топ (1.28), меряем спрос
}
